...
/** Depicts all the NYC Zip codes*/
let nycZipCodes: KeyValuePairs<Int, String> = [
    11201    :"Brooklyn",
    11203    :"Brooklyn",
    11204    :"Brooklyn",
    11205    :"Brooklyn",
...
/** Array with string literals of all the boroughs*/
let boroughs = ["Brooklyn","Queens","Manhattan","Bronx","Staten Island"]

/** List of all U.S. states*/
let states = ["New York","Alaska", "Alabama", "Arkansas", "American Samoa", "Arizona", "California", "Colorado", "Connecticut", "District of Columbia", "Delaware", "Florida", "Georgia", "Guam", "Hawaii", "Iowa", "Idaho", "Illinois", "Indiana", "Kansas", "Kentucky", "Louisiana", "Massachusetts", "Maryland", "Maine", "Michigan", "Minnesota", "Missouri", "Mississippi", "Montana", "North Carolina", "North Dakota", "Nebraska", "New Hampshire", "New Jersey", "New Mexico", "Nevada", "Ohio", "Oklahoma", "Oregon", "Pennsylvania", "Puerto Rico", "Rhode Island", "South Carolina", "South Dakota", "Tennessee", "Texas", "Utah", "Virginia", "Virgin Islands", "Vermont", "Washington", "Wisconsin", "West Virginia", "Wyoming"]
...
/**
 - Returns: All zipcodes associated with the provided borough, else empty if no borough is matched*/
func getZipCodesFor(this borough: Borough)->[Int]{
    var zipCodes: [Int] = []
    
    for (key, value) in nycZipCodes{
        if borough.rawValue == value{
            zipCodes.append(key)
        }
    }
