//
//  SignUpVCCollectionViewCell.swift
//  Stuy Wash N Dry
//
//  Created by Justin Cook on 2/15/22.
//

import UIKit

/** Simple Collection View Cell class that handles adding content to the content view and basic garbage disposal*/
class SignUpVCCollectionViewCell: UICollectionViewCell{
    static let identifier = "SignUpVCCollectionViewCell"
