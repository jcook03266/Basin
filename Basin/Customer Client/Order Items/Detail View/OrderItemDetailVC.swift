...
public class OrderItemDetailVC: UIViewController, UINavigationBarDelegate, UITableViewDelegate, UITableViewDataSource, UITextViewDelegate, GADBannerViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate{
    ...
    /** The collectionview from which this detail view originated from, can be used as a reference for refreshing when the cart data has been updated*/
    ...
    func configure(){
        ...
        helpButton.tintColor = fontColor
    ...
    func updatePresentingViews(){
        ...
        /** Reload the presenting collection view using the updated cart data*/
        if presentingCollectionView != nil{
            presentingCollectionView!.reloadData()
        }
    }
